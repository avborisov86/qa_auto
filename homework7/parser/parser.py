...
# Считаем количество разных запросов в одном файле (дополнительные параметры: 'all_requests', 'get_requests', 'post_requests', 'head_requests')
def count_requests_by_type(path_to_filename: str, param: str):
    ...
    if param == 'all_requests':
        ...
        json_data = {
            "Общее количество выполненных запросов из файла " + path_to_filename: all_req_quant
        }
        ...
        print('Общее количество выполненных запросов из файла ' + path_to_filename + " -", all_req_quant)
    ...
    # Считаем общее количество выполненных GET запросов
        ...
        json_data = {
            "Количество запросов типа GET из файла " + path_to_filename: get_req_quant
        }
        # Записываем найденные данные в json файл
        add_to_json(json_data)
        # Выводим в терминал данные о количестве GET запросов
        print('Количество запросов типа "GET" из файла ' + path_to_filename + " -", get_req_quant)
    ...
    # Считаем общее количество выполненных POST запросов
        ...
        json_data = {
            "Количество запросов типа POST из файла " + path_to_filename: post_req_quant
        }
        # Записываем найденные данные в json файл
        add_to_json(json_data)
        # Выводим в терминал данные о количестве POST запросов
        print('Количество запросов типа "POST" из файла ' + path_to_filename + " -", post_req_quant)
    ...
    # Считаем общее количество выполненных HEAD запросов
        ...
        json_data = {
            "Количество запросов типа HEAD из файла " + path_to_filename: head_req_quant
        }
        # Записываем найденные данные в json файл
        add_to_json(json_data)
        # Выводим в терминал данные о количестве GET запросов
        print('Количество запросов типа "HEAD" из файла ' + path_to_filename + " -", head_req_quant, "\n")
...
def count_requests_speed(path_to_filename: str):
    ...
    print('Топ 3х наиболее длительных запросов из файла ' + path_to_filename)
