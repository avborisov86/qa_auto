...
2. Логика для парсинга данных из файла "access.log" и сохранения их в нужном формате расположена в директории homework7/parser - "parser.py"
   ...
   _требует передачи дополнительного параметра - директории, где расположены исполняемые файлы или полный путь с указанием названия файла 
   (параметр передается к исполняемой функции из командной строки при запуске программы / type: str)_
